namespace FactoryDesignPatternApp_Simple
{
    ...
    {
        public static IAppetizers CreateAppetizer(string AppetizerType)
        {
            return AppetizerType switch
            {
        ...
        public static IDesserts CreateDessert(string DessertType) 
        {
            return DessertType switch
            {
        ...
        public static IMainDish CreateMainDish(string MainDishType)
        {
